...
const Header: React.FC = () => {
  ...
  return (
    <header className='from-alpha fixed z-20 w-full bg-background via-gray-500/20 to-transparent pt-4 before:absolute before:bottom-0 before:right-0 before:inline-block before:h-px before:w-[calc(100vw-200px)] before:bg-gradient-to-l'>
