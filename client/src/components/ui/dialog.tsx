...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    className={cn(
      'fixed inset-0 z-50 bg-border/25 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0',
      className
    )}
    {...props}
  />
    ...
    >
      ...
      <div>
        <DialogPrimitive.Close
          ...
          className='sr-only'
        ></DialogPrimitive.Close>
        {/* <DialogPrimitive.Close className='absolute right-[1.1rem] top-[1.1rem] rounded-full opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-accent data-[state=open]:text-muted-foreground'>
          <Icon.X />
